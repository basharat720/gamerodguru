          ...
          <Grid item container p={2}>
            <Grid item container rowGap={2}>
              ...
              <Typography sx={{ color: "black" }}>
                ...
                PayPal. UK GAMES EXPO 2019 Thank you to everyone who attended UK
                Games Expo and visited our booth. It was great to put some faces
                to names!
              </Typography>
              ...
              <Typography sx={{ color: "black" }} variant="caption">
                Thank you to everyone who attended UK Games Expo and visited our
                booth. It was great to put some faces to names!
              </Typography>
            </Grid>
